...
function ContactMe({}: Props) {
  ...
  const onSubmit: SubmitHandler<Inputs> = formData => {
    window.location.href = `mailto:blockchainbazz.team@gmail?subject=${formData.subject}&body=Hi, my name is ${formData.name}. ${formData.message} (${formData.email})`
  };
  ...
  return <div className='h-screen relative flex overflow-hidden flex-col md:text-left text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0 '>
    <h3 className='absolute top-24 uppercase tracking-[20px] text-gray-600 text-2xl px-10'>
         Contact
        </h3> 
        ...
        <h4 className='text-3xl font-semibold text-center'>
            ...
            <div className='space-y-5'>
                ...
                <div className='flex items-center space-x-3 justify-center'>
                   ...
                   <p className='text-2xl'>Unopposedpresident@gmail.com</p>
                </div>
            ...
            className=' flex flex-col space-y-2 w-fit mx-auto'>
                ...
                <div className='flex space-x-2'>
                 ...
                 <button type='submit' className='bg-green-500 py-3 px-10 rounded-md text-black font-bold text-lg'>
                    Sumbit
                </button>
