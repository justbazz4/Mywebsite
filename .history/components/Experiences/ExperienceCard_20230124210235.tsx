...
import nxtLOGO from '../../public/nxtLOGO.png';
      ...
      <div className='px-0 md:px-10'>
        <h4 className='text-4xl font-light'>CEO: I'stan Technologies and Innovations</h4>
         ...
         <ul className='list-disc space-y-0 ml-5 text-lg '>
           ...
           <Link></Link>   <span className='decoration-green-700 underline font-bold text-2xl px-2'> I'stan Technologies and Innovations </span></li>
