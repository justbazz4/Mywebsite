...
function ContactMe({}: Props) {
  ...
  return <div className='h-screen relative flex overflow-hidden flex-col md:text-left text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0 '>
    <h3 className='absolute top-24 bottom-3 uppercase tracking-[20px] text-gray-600 text-2xl mb-10'>
         Contact
        </h3> 
        ...
        <h4 className='text-3xl font-semibold text-center'>
            ...
            className=' flex flex-col space-y-2 w-fit mx-auto'>
                ...
                <div className='flex space-x-2'>
                 ...
                 <button type='submit' className='bg-green-500 py-3 px-10 rounded-md text-black font-bold bottom-5 
                  text-lg'>
                    Sumbit
                </button>
            </form>
