...
function Header({}: Props) {
  return (
     <header className='sticky p-5  flex item-start justify-between max-w-2xl mx-auto z-20
      xl:items-center top-455 '>
        <motion.div
          ...
          transition={{
           ...
           <SocialIcon url='https://www.twitter.com/mrbazz9' 
            ...
            bgColor='transparent'
            />
           <SocialIcon url='https://www.linkedin.com/in/sam-uket-373181251' 
            fgColor='gray'
            bgColor='transparent'
            />
